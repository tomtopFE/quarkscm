...
;(function($, document, undefined) {
	...
	Plugin.prototype = {
		...
		_createElements: function() {
			...
			ele.push('<input tag="countryCode" type="hidden" data-name="isocountry.isoCode" />');
			ele.push('<input tag="country" type="hidden" data-name="country"  />');
			ele.push('<input tag="countryName" type="hidden" name="countryName"  />');
			ele.push('<div class="address_country"><div tag="text" data-name="isocountry.name"></div><span><i></i></span></div>');
...
//			var countryCode = $('#' + this.options.id).find('input[tag=countryCode0]');
...
//			var phonenumber = $('#' + this.options.id).parents("#addShipAddressForm").find('input[name=ctelephone]');
